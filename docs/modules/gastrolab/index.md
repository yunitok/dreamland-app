---
title: GastroLab Module Overview
description: Gestión integral de restaurantes con IA - Documentación completa
---

# 🕵️ Módulo GastroLab - Visión General

## Executive Summary

GastroLab es el **módulo de gestión integral de restaurantes** para Dreamland App, que combina:
...
| Característica | Yurest | Gstock | **GastroLab** |
|----------------|--------|--------|--------------|
