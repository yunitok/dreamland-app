...
Esta guía detalla la integración de GastroLab con la plataforma **Yurest WebService API** para importar y sincronizar datos de ingredientes, recetas e inventario.
