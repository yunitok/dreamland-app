...
Esta guía detalla la integración de GastroLab con la plataforma **Gstock API** utilizando OAuth2, webhooks y sincronización bidireccional.
...
**Importación directa** (estructura idéntica a GastroLab):
```typescript
