...
import { AUDITABLE_ENDPOINTS } from "@/modules/calidad/domain/data-quality/endpoint-config"
import { analyzeField, detectStringFields } from "@/modules/calidad/domain/data-quality/analyzers"
import { buildEndpointSummary, buildFullReport } from "@/modules/calidad/domain/data-quality/report-builder"
import type {
  EndpointAuditResult,
  FieldAnalysis,
  FullAuditReport,
} from "@/modules/calidad/domain/data-quality/types"
...
export async function runFullDataQualityAudit(): Promise<{
  ...
  await requirePermission("calidad", "manage")
  ...
  for (const endpointConfig of AUDITABLE_ENDPOINTS) {
    ...
    try {
      ...
      results.push({
        ...
        gastrolabMapping: endpointConfig.gastrolabMapping,
