...
import { AnalyticsFilters, type FilterState } from "../../analytics/_components/analytics-filters"
...
} from "@/modules/sherlock/actions/agora-analytics"
        ...
        <Card className="rounded-xl border p-10 w-full">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              desde Agora TPV en la configuracion de Sherlock. Necesitas
              ejecutar al menos un sync de maestros para vincular los
              restaurantes.
            </p>
            <Button asChild className="mt-2">
              <Link href="/sherlock/settings">
        ...
        <Card className="rounded-xl border p-10">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <p className="text-sm text-muted-foreground max-w-md">
              ...
              Sincroniza mas dias desde la configuracion de Sherlock o ajusta
              los filtros.
            </p>
