...
import { runFullDataQualityAudit } from "@/modules/gastrolab/actions/data-quality"
import type { FullAuditReport } from "@/modules/gastrolab/domain/data-quality/types"
      ...
      {!report && !isPending && (
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center justify-center py-16 text-muted-foreground gap-3">
            ...
            <p className="text-xs">Se auditarán {12} endpoints con los campos que mapean a modelos de GastroLab</p>
          </CardContent>
        </Card>
      )}
