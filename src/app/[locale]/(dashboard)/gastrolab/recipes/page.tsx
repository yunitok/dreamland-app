...
import { getRecipes, getRecipeCategories, getRecipeFamilies } from "@/modules/gastrolab/actions/recipes"
import { Card, CardContent, CardHeader, CardTitle } from "@/modules/shared/ui/card"
import { Header } from "@/components/layout/header"
import { getTranslations } from "next-intl/server"

export default async function RecipesPage() {
    const t = await getTranslations("gastrolab.recipes")
    ...
    return (
        <div className="flex flex-col h-screen overflow-hidden">
            <Header
                titleKey="gastrolab.recipes.title"
                descriptionKey="gastrolab.recipes.description"
                backHref="/gastrolab"
            >
                <div className="flex items-center gap-2">
                    <Button size="sm" asChild className="h-8 sm:h-9">
                        <Link href="/gastrolab/recipes/new">
