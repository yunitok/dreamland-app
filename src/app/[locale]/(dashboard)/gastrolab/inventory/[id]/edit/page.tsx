...
import { getInventoryRecord } from "@/modules/gastrolab/actions/inventory"
...
export default async function EditInventoryPage({ params }: EditInventoryPageProps) {
    ...
    return (
        <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
            <Header
                titleKey="gastrolab.inventory.edit.title"
                descriptionKey="gastrolab.inventory.edit.description"
            />
