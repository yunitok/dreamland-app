...
import { inventoryRecordSchema, InventoryRecordFormValues } from "@/modules/gastrolab/schemas"
import { createInventoryRecord, updateInventoryRecord } from "@/modules/gastrolab/actions/inventory"
...
export function InventoryForm({ initialData, ingredients }: InventoryFormProps) {
    ...
    async function onSubmit(data: InventoryRecordFormValues) {
        try {
            ...
            router.push("/gastrolab/inventory")
            router.refresh()
        } catch (error) {
