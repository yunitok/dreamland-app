...
import { getWasteRecords } from "@/modules/gastrolab/actions/waste"
...
export default async function WastePage() {
    ...
    return (
        <div className="flex flex-col h-screen overflow-hidden">
            <Header
                titleKey="gastrolab.waste.title"
                descriptionKey="gastrolab.waste.description"
            >
                <Button size="sm" asChild>
                    <Link href="/gastrolab/waste/new">
