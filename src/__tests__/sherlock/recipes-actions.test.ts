...
import {
  ...
  getRecipeCategories,
  getRecipeFamilies,
} from "@/modules/sherlock/actions/recipes"
...
describe("createRecipe", () => {
  ...
  it("crea una receta con ingredientes", async () => {
    ...
    expect(mockRevalidatePath).toHaveBeenCalledWith("/sherlock/recipes")
    expect(result).toEqual(MOCK_RECIPE)
  })
...
describe("updateRecipe", () => {
  ...
  it("actualiza una receta eliminando ingredientes previos", async () => {
    ...
    expect(mockRevalidatePath).toHaveBeenCalledWith("/sherlock/recipes")
    expect(mockRevalidatePath).toHaveBeenCalledWith("/sherlock/recipes/recipe-1")
    expect(result).toEqual(MOCK_RECIPE)
  })
