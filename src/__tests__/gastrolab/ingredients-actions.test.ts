...
import {
  ...
  updateIngredient,
  deleteIngredient,
} from "@/modules/gastrolab/actions/ingredients"
...
describe("getIngredients", () => {
  it("requiere permiso read:gastrolab", async () => {
...
describe("createIngredient", () => {
  it("requiere permiso manage:gastrolab", async () => {
  ...
  it("llama revalidatePath('/gastrolab/ingredients')", async () => {
    mockCreate.mockResolvedValue(mockIngredient)
    await createIngredient(validData)
    expect(mockRevalidatePath).toHaveBeenCalledWith("/gastrolab/ingredients")
  })
})
...
describe("updateIngredient", () => {
  ...
  it("llama revalidatePath 2 veces: '/gastrolab/ingredients' y '/gastrolab/ingredients/ing-1/edit'", async () => {
    mockUpdate.mockResolvedValue(mockIngredient)
    await updateIngredient("ing-1", validData)
    expect(mockRevalidatePath).toHaveBeenCalledTimes(2)
    expect(mockRevalidatePath).toHaveBeenCalledWith("/gastrolab/ingredients")
    expect(mockRevalidatePath).toHaveBeenCalledWith("/gastrolab/ingredients/ing-1/edit")
  })
})
