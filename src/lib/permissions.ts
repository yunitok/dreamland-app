...
export type PermissionResource = 'admin' | 'users' | 'roles' | 'projects' | 'settings' | 'departments' | 'sentiment' | 'tasks' | 'lists' | 'comments' | 'attachments' | 'tags' | 'gastrolab' | 'sherlock' | 'calidad' | 'analytics' | 'reports' | 'atc' | 'knowledge-base'
