...
export type Resource = 'projects' | 'tasks' | 'users' | 'roles' | 'sentiment' | 'departments' | 'ai' | 'admin' | 'gastrolab' | 'sherlock' | 'calidad' | 'analytics' | 'reports' | 'settings' | 'lists' | 'comments' | 'attachments' | 'tags' | 'atc' | 'knowledge-base'
