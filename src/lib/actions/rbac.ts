...
export type Resource = 'projects' | 'tasks' | 'users' | 'roles' | 'sentiment' | 'departments' | 'ai' | 'admin' | 'sherlock' | 'reports' | 'settings' | 'lists' | 'comments' | 'attachments' | 'tags' | 'atc' | 'knowledge-base'
