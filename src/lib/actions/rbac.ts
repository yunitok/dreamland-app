...
export type Resource = 'projects' | 'tasks' | 'users' | 'roles' | 'sentiment' | 'departments' | 'ai' | 'admin' | 'gastrolab' | 'reports' | 'settings' | 'lists' | 'comments' | 'attachments' | 'tags' | 'atc' | 'knowledge-base'
